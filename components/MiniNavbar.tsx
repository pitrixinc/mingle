...
const MiniNavbar = () => {
  ...
  return (
    <div className="absolute z-index-1 w-full flex justify-between items-center border-b-2 border-gray-200 py-1 px-1 xl:hidden md:hidden block shadow-sm mt-0 h-16 bg-white">
