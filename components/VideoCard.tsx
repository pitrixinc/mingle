                ...
                <Link href={`/detail/${post._id}`}>
                  ...
                  <div>
                    ...
                    <video
                       loop
                       ref={videoRef}
                       className="lg:w-[600px] h-[300px] md:h-[400px] lg:h-[320px] w-[100%] w-full sm:w-full aspect-video md:rounded xl:rounded cursor-pointer bg-black mr-0 object-cover"
